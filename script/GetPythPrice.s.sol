...
contract GetPythPriceScript is Script {
    function run() external {
        ...
        console.log("Calling getKbtcUsdPrice...");
        ...
        try getPythContract.getKbtcUsdPrice{value: 0.1 ether}(updateData, 100000) returns (PythStructs.Price memory price) {
            // Log the price details
            console.log("KBTC/USD Price Result:");
            ...
            console.log("Error calling getKbtcUsdPrice:", reason);
        } catch (bytes memory lowLevelData) {
            console.log("Unknown error calling getKbtcUsdPrice");
