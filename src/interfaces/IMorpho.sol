...
interface IMorpho {
    ...
    /// @param id The id of the created market.
    /// @param loanToken The address of the loan token of the created market.
    /// @param collateralToken The address of the collateral token of the created market.
    /// @param oracle The address of the oracle of the created market.
    /// @param irm The address of the IRM of the created market.
    /// @param lltv The LLTV of the created market.
    event CreateMarket(
        uint256 indexed id,
